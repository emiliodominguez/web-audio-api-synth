...
export const controlsGroups = Object.freeze([
    ...
    },
    {
        ...
        controls: [
            { type: "knob", class: "knob", label: "Filter amount", id: "filter-amount", min: 50, max: 16000, step: 1 },
            { type: "knob", class: "knob", label: "Resonance", id: "filter-q", min: 0.1, max: 30, step: 0.01 },
            { type: "knob", class: "knob", label: "Filter Gain", id: "filter-gain", min: -40, max: 40, step: 0.01 },
        ],
    },
    {
        name: "Envelope",
        controls: [
            { type: "knob", class: "knob", label: "Attack time", id: "attack-time", min: 0, max: 0.5, step: 0.01 },
            { type: "knob", class: "knob", label: "Release time", id: "release-time", min: 0, max: 0.5, step: 0.01 },
            { type: "knob", class: "knob", label: "Note length", id: "note-length", min: 0.2, max: 2, step: 0.01 },
        ],
    },
    {
        name: "Vibrato",
        controls: [
            { type: "knob", class: "knob", label: "Vibrato amount", id: "vibrato-amount", min: 0, max: 5, step: 0.1 },
            { type: "knob", class: "knob", label: "Vibrato speed", id: "vibrato-speed", min: 0, max: 30, step: 0.1 },
        ],
    },
    {
        name: "Delay",
        controls: [
            { type: "knob", class: "knob", label: "Delay amount", id: "delay-amount", min: 0, max: 1, step: 0.01 },
            { type: "knob", class: "knob", label: "Delay time", id: "delay-time", min: 0, max: 1, step: 0.01 },
            { type: "knob", class: "knob", label: "Feedback", id: "feedback", min: 0, max: 1, step: 0.01 },
        ],
    },
]);
